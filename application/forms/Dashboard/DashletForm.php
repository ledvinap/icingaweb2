    ...
    protected function onSuccess()
    {
        ...
        if (! $this->isUpdating()) {
            ...
            if ($currentPane->hasEntry($currentDashlet->getName())
                ...
                Notification::error(sprintf(
                    t('Failed to move a Dashlet: Dashboard Pane "%s" has already a Dashlet called "%s"'),
                    $currentPane->getTitle(),
            ...
            try {
                ...
                Notification::error(t('Failed to successfully update the Dashlet. Please check the logs for details!'));
